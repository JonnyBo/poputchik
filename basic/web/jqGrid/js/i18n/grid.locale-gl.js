...
var locInfo = {
	...
	search: {
		...
		odata: [
			...
			{ oper: "ni", text: "non estГЎ en" },
			{ oper: "ew", text: "termina por" },
			{ oper: "en", text: "non termina por" },
			{ oper: "cn", text: "contГ©n" },
			{ oper: "nc", text: "non contГ©n" },
	...
	edit: {
		...
		bCancel: "Cancelar",
		bClose: "Pechar",
		saveData: "ModificГЎronse os datos, quere gardar os cambios?",
		bYes: "Si",
		bNo: "Non",
		bExit: "Cancelar",
		msg: {
			required: "Campo obrigatorio",
			number: "Introduza un nГєmero",
			minValue: "O valor debe ser maior ou igual a ",
			maxValue: "O valor debe ser menor ou igual a ",
			email: "non Г© un enderezo de correo vГЎlido",
			integer: "Introduza un valor enteiro",
			date: "Introduza unha data correcta ",
			url: "non Г© unha URL vГЎlida. Prefixo requerido ('http://' ou 'https://')",
			nodefined: " non estГЎ definido.",
			novalue: " o valor de retorno Г© obrigatorio.",
			customarray: "A funciГіn persoalizada debe devolver un array.",
			customfcheck: "A funciГіn persoalizada debe estar presente no caso de ter validaciГіn persoalizada."
		}
	},
	view: {
	...
	formatter: {
		...
		date: {
			dayNames:   [
				...
				"Domingo", "Luns", "Martes", "MГ©rcoles", "Xoves", "Vernes", "SГЎbado"
			],
			monthNames: [
				"Xan", "Feb", "Mar", "Abr", "Mai", "XuГ±", "Xul", "Ago", "Set", "Out", "Nov", "Dec",
				"Xaneiro", "Febreiro", "Marzo", "Abril", "Maio", "XuГ±o", "Xullo", "Agosto", "Setembro", "Outubro", "Novembro", "Decembro"
			],
			AmPm: ["am", "pm", "AM", "PM"],
			S: function (j) {
