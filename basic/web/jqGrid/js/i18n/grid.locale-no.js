	...
	var locInfo = {
		...
		search: {
			...
			odata: [
				...
				{ oper: "gt", text: "stГёrre enn" },
				{ oper: "ge", text: "stГёrre eller lik" },
		...
		edit: {
			...
			msg: {
				...
				minValue: "verdi mГҐ vГ¦re stГёrre enn eller lik",
				maxValue: "verdi mГҐ vГ¦re mindre enn eller lik",
				email: "er ikke en gyldig e-post adresse",
				integer: "Legg inn et gyldig heltall",
				date: "Legg inn en gyldig dato",
				url: "er ikke en gyldig URL. Prefiks pГҐkrevd ('http://' eller 'https://')",
				nodefined: " er ikke definert!",
				novalue: " returverdi er pГҐkrevd!",
				customarray: "Tilpasset funksjon mГҐ returnere en tabell!",
				customfcheck: "Tilpasset funksjon mГҐ eksistere!"
			}
		},
		view: {
			caption: "Г…pne post",
		...
		errors: {
			...
			norecords: "Ingen poster ГҐ behandle",
