 ...
 * TraduГ§ГЈo da jqGrid em Portugues por Frederico Carvalho, http://www.eyeviewdesign.pt
...
var locInfo = {
	...
	edit: {
		...
		msg: {
			...
			email: "NГЈo Г© um endereГ§o de email vГЎlido",
	...
	errors: {
		errcap: "Erro",
		nourl: "NГЈo especificou um url",
		norecords: "NГЈo existem dados para processar",
	...
	formatter: {
		...
		date: {
			dayNames:   [
				...
				"Domingo", "Segunda-Feira", "TerГ§a-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "SГЎbado"
			],
			monthNames: [
...
$.extend(true, $.jgrid, {
	...
	locales: {
		...
		pt: $.extend({}, locInfo, { name: "PortuguГЄs", nameEnglish: "Portuguese" }),
		"pt-PT": $.extend({}, locInfo, { name: "portuguГЄs (Portugal)", nameEnglish: "Portuguese (Portugal)" })
	}
});
}));
